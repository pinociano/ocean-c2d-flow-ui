...
class OceanConfig:
    ...
    def get_config(d) -> Config:
        ...
        config[SECTION_RESOURCES][NAME_METADATA_CACHE_URI] = metadataCacheUri
        config[SECTION_RESOURCES][NAME_PROVIDER_URL] = providerUri
